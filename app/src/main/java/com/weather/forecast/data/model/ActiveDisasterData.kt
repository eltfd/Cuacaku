...
enum class ActiveDisasterType(
    ...
    FLOOD("Banjir", "🌊", 0xFF1565C0),
    FLASH_FLOOD("Banjir Bandang", "⚡🌊", 0xFF0D47A1),
    LANDSLIDE("Tanah Longsor", "⛰️", 0xFF795548),
    TIDAL_FLOOD("Banjir Rob", "🌊🌙", 0xFF00838F),
    CYCLONE("Siklon Tropis", "🌀", 0xFF880E4F),
    EARTHQUAKE("Gempa Bumi", "📳", 0xFFD84315),
    VOLCANIC("Erupsi Gunung Api", "🌋", 0xFFBF360C),
    TSUNAMI("Tsunami", "🌊💨", 0xFF01579B),
    DROUGHT("Kekeringan", "☀️🔥", 0xFFE65100),
    OTHER("Bencana Lainnya", "⚠️", 0xFF616161)
}
